...
import com.navigation.DownloadingNode;
import com.navigation.FailNode;
import com.navigation.FinishNode;
import com.state.Connecting;
import com.state.Downloading;
import com.state.Failed;
import com.state.Finished;
import com.state.Pause;
import com.state.TaskState;

public class DownloadContext implements Serializable {
	private static final long serialVersionUID = -4784955072037224135L;
