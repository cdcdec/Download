...
public class NewTaskFrame extends JFrame {
	private static final long serialVersionUID = -5318089693251154857L;
	//下载地址
	...
	private void createThreadCountSelect() {
		this.threadCount = new JComboBox<Integer>();
	...
	class FolderChooser extends JFileChooser {
		private static final long serialVersionUID = 7390881821564675957L;
